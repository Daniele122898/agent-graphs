...
from ..domain.models import AgentLifecycle, SessionInfo, SessionMode, SessionStatus, TeamGraph
from .stats import UsageTally
from ..util import iso_now, new_id

if TYPE_CHECKING:  # workers.py imports sessions.py; this avoids the cycle
    from .workers import RunningAgent
...
class Session:
    ...
    def __init__(
        ...
        *,
        ...
        from ..agents.questions import QuestionBoard  # local import: avoids a module cycle
