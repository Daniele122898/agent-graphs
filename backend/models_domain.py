...
"""LLM execution gateway mode for a session (see gateway.py, Phase 6)."""
...
class Capabilities(BaseModel):
    ...
    Enforcement of these globs lives in the tool layer (capabilities.py /
    tools.py), never in persona prose.
    """
...
class SessionInfo(BaseModel):
    ...
    object in sessions.py owns the non-serializable runtime parts)."""
...
class Task(BaseModel):
    ...
    tasks.py (Phase 5); this is the persisted shape."""
